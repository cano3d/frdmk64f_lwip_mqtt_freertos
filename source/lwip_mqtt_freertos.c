...
static void mqtt_incoming_publish_cb(void *arg, const char *topic, u32_t tot_len)
{
    ...
    if (0 == strcmp (topic, "cano3d/feeds/button"))
    	active_topic = 1;
    if (0 == strcmp (topic, "cano3d/feeds/temp"))
        	active_topic = 2;
    if (0 == strcmp (topic, "cano3d/feeds/dispense"))
        	active_topic = 3;
...
{
    static const char *topics[] = {"cano3d/feeds/button" , "cano3d/feeds/temp" , "cano3d/feeds/dispense"};
    int qos[]                   = {0, 1 , 2};
    err_t err;
    int i;
